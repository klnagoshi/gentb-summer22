...
#SBATCH -o strain-id-match-check_%j.out                 # File to which STDOUT will be written, including job ID (%j)
#SBATCH -e strain-id-match-check_%j.err                 # File to which STDERR will be written, including job ID (%j)
...
python3 strain-id-match-check.py
...
#SBATCH -o Fill-Blank-Lineages.py_%j.out                 # File to which STDOUT will be written, including job ID (%j)
#SBATCH -e Fill-Blank-Lineages.py_%j.err                 # File to which STDERR will be written, including job ID (%j)
...
python3 Fill-Blank-Lineages.py
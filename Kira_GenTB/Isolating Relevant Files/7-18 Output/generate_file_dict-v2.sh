...
#SBATCH -o dict_of_relevant_files-v2.py_%j.out                 # File to which STDOUT will be written, including job ID (%j)
#SBATCH -e dict_of_relevant_files-v2.py_%j.err                 # File to which STDERR will be written, including job ID (%j)
...
python3 dict_of_relevant_files-v2.py
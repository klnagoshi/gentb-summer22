...
#SBATCH -o generate-mutation-db_8-2_%j.out                 # File to which STDOUT will be written, including job ID (%j)
#SBATCH -e generate-mutation-db_8-2_%j.err                 # File to which STDERR will be written, including job ID (%j)

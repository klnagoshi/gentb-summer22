...
#SBATCH -o mutation_processing_8-2_%j.out                 # File to which STDOUT will be written, including job ID (%j)
#SBATCH -e mutation_processing_8-2_%j.err                 # File to which STDERR will be written, including job ID (%j)
...
python3 mutation_processing.py
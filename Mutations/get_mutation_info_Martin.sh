...
#SBATCH -o get_mutation_info_Martin_8-2_%j.out                 # File to which STDOUT will be written, including job ID (%j)
#SBATCH -e get_mutation_info_Martin_8-2_%j.err                 # File to which STDERR will be written, including job ID (%j)
...
python3 get_mutation_info_Martin.py
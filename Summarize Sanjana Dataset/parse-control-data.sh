...
#SBATCH -o summarize_only-no_nas_7-26_%j.out                 # File to which STDOUT will be written, including job ID (%j)
#SBATCH -e summarize_only-no_nas_7-26_%j.err                 # File to which STDERR will be written, including job ID (%j)
...
python3 summarize_only-no_nas.py
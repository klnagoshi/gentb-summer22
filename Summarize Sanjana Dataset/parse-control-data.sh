...
#SBATCH -o parse-control-data_7-24_%j.out                 # File to which STDOUT will be written, including job ID (%j)
#SBATCH -e parse-control-data_7-24_%j.err                 # File to which STDERR will be written, including job ID (%j)
